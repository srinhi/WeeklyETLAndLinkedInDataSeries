...
**Source:** [NYC Open Data — 311 Service Requests from 2020 to Present](https://data.cityofnewyork.us/Social-Services/311-Service-Requests-from-2020-to-Present/erm2-nwe9/about_data), filtered to HPD (Department of Housing Preservation and Development) complaints, pulled via the Socrata API. *(July records only)*
